...
try {
    $options = [
        ...
        PDO::MYSQL_ATTR_SSL_CA => '/etc/ssl/certs/BaltimoreCyberTrustRoot.crt.pem', // Certificado raíz
        PDO::MYSQL_ATTR_SSL_VERIFY_SERVER_CERT => false // Desactivar validación del certificado
    ];
